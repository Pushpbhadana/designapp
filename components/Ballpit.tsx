...
// Using simple environment instead of RoomEnvironment to avoid import issues
...
class X {
  ...
  #initRenderer() {
    ...
    if (!this.canvas) {
      console.error('Three: Canvas is null');
      return;
    }
    ...
    console.log('Three: Canvas element:', this.canvas);
    console.log('Three: Canvas dimensions:', this.canvas.offsetWidth, 'x', this.canvas.offsetHeight);
    console.log('Three: Canvas in DOM:', document.body.contains(this.canvas));
    
    // Try with no options first
    try {
      this.renderer = new WebGLRenderer({ canvas: this.canvas });
      console.log('Three: Basic renderer created successfully');
    } catch (error) {
      console.error('Three: Basic renderer creation failed:', error);
      throw error;
    }
    
    if (!this.renderer) {
      throw new Error('Three: WebGLRenderer initialization returned null');
    }
...
class Z extends InstancedMesh {
  ...
  constructor(renderer: WebGLRenderer, params: Partial<typeof XConfig> = {}) {
    ...
    // Simple environment without RoomEnvironment
  ...
  useEffect(() => {
    ...
    const initTimeout = setTimeout(() => {
      ...
      if (!document.body.contains(canvas)) {
        console.warn('Ballpit: Canvas not in DOM');
        return;
      }
