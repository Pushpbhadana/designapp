...
export default function Home() {
  return (
    <>
      ...
      <div className='
        text-gray-300 font-[990] 
        flex flex-col items-center 
        pt-20 md:pt-30 
        text-[calc(8vw+3vh)] md:text-[calc(11vw+5vh)] 
        leading-[1.2] md:leading-50 
        font-stretch-[500%] scale-y-140 tracking-[-0.07em] 
        cursor-pointer 
        text-center
        px-4
      '>
        I BUILD SITES
        <div className='text-red-500 text-[calc(5vw+3vh)] md:text-[calc(7vw+5vh)] tracking-tight'>
          THAT DOMINATE
        </div>
      </div>
      ...
      <VideoReveal 
        videoSrc="https://media.istockphoto.com/id/2211012335/video/empty-office-building-after-work-hours.mp4?s=mp4-640x640-is&k=20&c=BxnBWB9yrs5a21dO4lcwPnFM8q28rc6nUMtQ-g-GpOk="  
        alt='novideo'
      />
